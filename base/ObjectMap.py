...
class ObjectMap:
    ...
    def element_fill_value(self, driver, locate_type, locator_expression, fill_value, timeout=30):
        ...
        try:
            # 清楚输入框的原有值
            element.clear()
        except StaleElementReferenceException:  # 页面元素如果没有刷新出来，就对元素进行异常捕获，从而引发这个异常
    ...
    def element_click(
        ...
        :param locator_expression_appear:等待元素出现的定位方式类型
        :param timeout:超时时间
        :return:
        '''
        # 元素要可见
    ...
    def upload(self, driver, locata_type, locator_expression, file_path):
        '''
        文件上传
        :param driver:
        :param locata_type:
